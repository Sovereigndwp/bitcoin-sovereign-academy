...
class TransactionBuilderEnhanced {
  ...
  addDifficultySelector() {
    ...
    const difficultyHTML = `
      <div class="difficulty-selector" style="margin-top: 1.5rem;">
        ...
        <div class="difficulty-buttons" style="display: flex; gap: 0.75rem; justify-content: center; flex-wrap: wrap;">
          <button class="difficulty-btn active" data-difficulty="guided" style="background: rgba(255, 122, 0, 0.2); border: 2px solid var(--primary-orange); color: var(--text-light); padding: 0.75rem 1.25rem; border-radius: 10px; cursor: pointer; transition: all 0.3s; font-size: 0.9rem;">
            🎓 Guided
            <div style="font-size: 0.75rem; opacity: 0.8; margin-top: 0.25rem;">Step-by-step with hints</div>
          </button>
          <button class="difficulty-btn" data-difficulty="interactive" style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 122, 0, 0.3); color: var(--text-light); padding: 0.75rem 1.25rem; border-radius: 10px; cursor: pointer; transition: all 0.3s; font-size: 0.9rem;">
            🔧 Interactive
            <div style="font-size: 0.75rem; opacity: 0.8; margin-top: 0.25rem;">Hands-on learning</div>
          </button>
          <button class="difficulty-btn" data-difficulty="challenge" style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 122, 0, 0.3); color: var(--text-light); padding: 0.75rem 1.25rem; border-radius: 10px; cursor: pointer; transition: all 0.3s; font-size: 0.9rem;">
            🏆 Challenge
            <div style="font-size: 0.75rem; opacity: 0.8; margin-top: 0.25rem;">Quiz mode</div>
          </button>
          <button class="difficulty-btn" data-difficulty="expert" style="background: rgba(0, 0, 0, 0.3); border: 2px solid rgba(255, 122, 0, 0.3); color: var(--text-light); padding: 0.75rem 1.25rem; border-radius: 10px; cursor: pointer; transition: all 0.3s; font-size: 0.9rem;">
            ⚡ Expert
    ...
    document.querySelectorAll('.difficulty-btn').forEach(btn => {
      btn.addEventListener('click', (e) => {
        document.querySelectorAll('.difficulty-btn').forEach(b => {
          ...
          b.style.borderColor = 'rgba(255, 122, 0, 0.3)';
        });
    ...
    if (initialBtn) {
      ...
      initialBtn.style.background = 'rgba(255, 122, 0, 0.2)';
      ...
      <div class="transaction-flow-viz" style="background: rgba(0, 0, 0, 0.2); padding: 1.5rem; border-radius: 10px; margin: 1.5rem 0;">
        ...
        <div style="display: flex; align-items: center; justify-content: space-around; gap: 1rem; flex-wrap: wrap;">
          ...
          <div style="flex: 1; min-width: 150px;">
            ...
            <div style="background: rgba(255, 122, 0, 0.2); border: 2px solid var(--primary-orange); padding: 1rem; border-radius: 8px; text-align: center; min-height: 100px; display: flex; flex-direction: column; justify-content: center;">
