    ...
    function lockEntireModule() {
        ...
        lockOverlay.innerHTML = `
            <div style="max-width: 500px; text-align: center; color: white; font-family: system-ui;" tabindex="-1">
                ...
                <h2 id="module-lock-title" style="font-size: 2rem; margin: 0 0 1rem; color: #FF7A00;">Module Locked</h2>
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem; align-items: center;">
                    ...
                    <a href="/"
                       style="display: inline-block; color: #FF7A00; text-decoration: none; font-weight: 600; padding: 0.75rem 1.5rem; border: 2px solid #FF7A00; border-radius: 999px;">
                        ← Back to Home
                    </a>
                    <p style="color: #b5b5b5; font-size: 0.9rem; margin-top: 1rem;">
                        Not a member? <a href="/#unlock" style="color: #FF7A00; text-decoration: underline;">Join now</a>
                    </p>
                </div>
            </div>
        `;
