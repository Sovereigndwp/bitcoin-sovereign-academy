...
class GeminiTutorUI {
    ...
    createTutorButton() {
        ...
        button.addEventListener('mouseenter', () => {
            button.style.background = 'rgba(255, 122, 0, 0.1)';
    ...
    createChatInterface() {
        ...
        container.style.cssText = `
            ...
            background: #1a1a1a;
            border-radius: 16px;
            box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 122, 0, 0.2);
            z-index: 9999;
            display: none;
        ...
        container.innerHTML = `
            ...
            ">
                <div>
                    <h3 style="margin: 0; font-size: 16px; color: #FF7A00; font-weight: 700;">🎓 AI Bitcoin Tutor</h3>
            ...
            ">
                ...
                <div id="api-key-notice" style="margin-top: 10px; font-size: 11px; color: #666; display: none;">
                    <a href="#" id="api-key-link" style="color: #FF7A00;">⚙️ Configure API Key</a> to enable AI responses
                </div>
            </div>
        `;
    ...
    bindEvents() {
        ...
        this.chatInput.addEventListener('focus', () => {
            this.chatInput.style.borderColor = 'rgba(255, 122, 0, 0.5)';
        });
        this.chatInput.addEventListener('blur', () => {
            this.chatInput.style.borderColor = 'rgba(255, 122, 0, 0.2)';
        });
...
I use the Socratic method - I'll ask questions to help you discover insights yourself rather than just giving answers.`;
    ...
    addQuickQuestions() {
        ...
        questions.forEach(q => {
            ...
            btn.addEventListener('mouseenter', () => {
                ...
                btn.style.borderColor = 'rgba(255, 122, 0, 0.4)';
            });
            btn.addEventListener('mouseleave', () => {
                btn.style.background = 'rgba(255, 122, 0, 0.1)';
                btn.style.borderColor = 'rgba(255, 122, 0, 0.2)';
            });
    ...
    createMessage(text, role) {
        ...
        msg.style.cssText = `
            ...
            background: ${isUser ? 'linear-gradient(135deg, #FF7A00 0%, #e88a17 100%)' : isError ? 'rgba(244, 67, 54, 0.15)' : 'rgba(255, 255, 255, 0.05)'};
    ...
    createTypingIndicator() {
        ...
        indicator.innerHTML = `
            <div style="display: flex; gap: 5px;">
                <div class="dot" style="width: 8px; height: 8px; background: #FF7A00; border-radius: 50%; animation: typing 1.4s infinite;"></div>
                <div class="dot" style="width: 8px; height: 8px; background: #FF7A00; border-radius: 50%; animation: typing 1.4s infinite 0.2s;"></div>
                <div class="dot" style="width: 8px; height: 8px; background: #FF7A00; border-radius: 50%; animation: typing 1.4s infinite 0.4s;"></div>
            </div>
        `;
