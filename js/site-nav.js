...
(function () {
    ...
    .bsa-nav__brand {
        ...
        text-decoration: none; color: #f7931a; font-weight: 700; font-size: 1rem;
        white-space: nowrap;
    }
    ...
    .bsa-nav__links a:hover, .bsa-nav__links a.active { color: #f7931a; }
    .bsa-nav__cta {
    ...
    .bsa-nav__cta:hover { box-shadow: 0 2px 12px rgba(247,147,26,0.4); color: #000 !important; }
    .bsa-nav__progress {
        display: flex; align-items: center; gap: 0.5rem;
    ...
    .bsa-nav__progress-fill {
        height: 100%; background: linear-gradient(90deg, #f7931a, #ffb347); border-radius: 3px;
