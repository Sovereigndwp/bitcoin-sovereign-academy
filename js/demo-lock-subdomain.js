            ...
            <div style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:#000;color:#fff;text-align:center;font-family:system-ui;padding:20px;">
                <div style="max-width:500px;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:12px;align-items:center;">
                        ...
                        <a href="/"
                           style="display:inline-block;color:#FF7A00;text-decoration:none;font-weight:600;font-size:1rem;padding:8px 16px;border:2px solid #FF7A00;border-radius:8px;transition:all 0.2s;">
                            ← Back to Home
                        </a>
                        <p style="color:#666;font-size:0.85rem;margin-top:12px;">
                            Not a member? <a href="/#unlock" style="color:#FF7A00;text-decoration:underline;">Learn more</a>
                        </p>
                    </div>
                </div>
            </div>
